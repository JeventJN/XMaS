...
<body class="overflow-hidden">
    <div class="flex w-screen">
        <div class="w-[72.5%] h-[47vw] bg-[#395474]">
            ...
            {{-- Nama Eskul --}}
            <div class="w-[100%] h-[3vw] text-white font-nunito font-bold text-[3vw] flex justify-center items-center">Running</div>
            <div class="w-[100%] flex justify-center items-center h-[29vw]">
                <div class="w-[40vw] h-[27vw] bg-[#D9D9D9] rounded-[3vw] flex flex-col items-center justify-center">
                    <img src="{{ asset('/Assets/RunningLogo.png') }}" class="absolute max-w-[10vw] min-w-[10vw] max-h-[10vw] min-h-[10vw] mb-[27vw] ml-[40vw] rounded-[50%]" alt="">
                            ...
                            <div class="w-[100%] bg-[#395474] rounded-[1vw]">
                                <div class="flex w-[100%] h-[2.5vw] items-center justify-start">
                                    ...
                                    <div class="w-[90%] h-[2.2vw] flex items-center">
                                        <label class="ml-[2vw] text-[2vw] text-white font-light">Jordan Halim</label>
                                    </div>
                                    {{-- value isi nama anggota --}}
                                    <div class="w-[10%] flex justify-center items-center">
                                        <input class="h-[1.5vw] rounded-[1vw] w-[1.5vw]" type="checkbox" value="Jordan" label="Jordan Halim" onclick="updateAttendanceCount(this)">
                                    </div>
                                </div>
                            </div>
                            <div class="h-[1vw]"></div>
            ...
            <div class="w-[100%] flex h-[9vw]">
                <div class="w-[70%] flex flex-col justify-center items-start ml-[1vw]">
                    ...
                    <div class="text-[2vw] text-white font-nunito font-bold "> Leader &nbsp &nbsp :</div>
                    <div class="text-[2vw] text-white font-nunito font-bold "> Location &nbsp:</div>
                ...
                <div class="w-[30%] flex flex-col justify-center items-center">
                    ...
                    <div id="attendanceCount" class="ml-[3vw] text-white text-[1.5vw]">Presence 0/10</div>
                    <form action="" method="post">
                        <button class="ml-[3vw] w-[17vw] h-[5vw] text-[2vw] font-nunito font-bold rounded-[1vw] bg-[#D9D9D9] flex justify-center items-center hover:bg-[#1B2F45] hover:text-white">Submit</button>
                    </form>
                </div>
            </div>
